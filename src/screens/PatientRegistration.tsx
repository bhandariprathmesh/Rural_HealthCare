...
export default function PatientRegistration({ navigate, isOffline }: Props) {
  ...
  async function handleSubmit() {
    ...
    if (
      ...
      setError(
        "Please fill out all mandatory medical info. Enter 'None' if applicable.",
      )
    ...
    try {
      ...
      const cleanEmergencyPhone = form.emergencyPhone
        .replace(/\D/g, "")
        .slice(-10)
      ...
      if (isHttpValidationOrAuthError || isDuplicateError) {
        ...
        setError(
          err.message || "Validation failed. Please check the patient details.",
        )
  ...
  const inputClass =
    "w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent bg-white"
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">
            Create a secure longitudinal health record
          </p>
        </div>
        {isOffline ? (
          ...
          <div key={i} className="flex items-center gap-2 flex-1">
            ...
            <span
              className={`text-xs hidden sm:block ${
                i === step ? "text-brand-700 font-semibold" : "text-gray-400"
              }`}
            >
              {s}
            </span>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2 pt-2 border-t border-gray-100">
                ...
                <p className="text-[11px] text-gray-500 mt-1">
                  12-digit Aadhaar number is mandatory for ABDM ABHA ID
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-500 mt-0.5">
                  Default is 1234. Patient uses this PIN to log in.
                </p>
              </div>
              <div>
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Ward no., Mohalla, Landmark..."
                  rows={2}
        ...
        {step === 2 && (
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-500">
              Only collect what is known and relevant. Leave blank if unknown.
            </p>
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Penicillin, Aspirin (comma separated) or 'None'"
                  className={inputClass}
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g. Diabetes, Hypertension, Anaemia, or 'None'..."
                  rows={2}
                  className={`${inputClass} resize-none`}
                />
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-700 mt-1 leading-relaxed">
                    By registering, the patient agrees that their health
                    information will be securely stored and can be accessed only
                    by authorized healthcare providers with their explicit
                    consent. Patient can revoke access at any time.
                  </p>
                  <label className="flex items-center gap-2 mt-2 cursor-pointer">
                    ...
                    <span className="text-xs font-medium text-blue-800">
                      Patient has given verbal/written consent
                    </span>
                  </label>
                </div>
              </div>
        ...
        {step === 3 && (
          <div className="text-center space-y-6">
            <div
              className={`w-16 h-16 ${
                isSavedOffline ? "bg-amber-100" : "bg-green-100"
              } rounded-full flex items-center justify-center mx-auto`}
            >
              <Icon
                name={isSavedOffline ? "wifi_off" : "check"}
                size={28}
                className={isSavedOffline ? "text-amber-600" : "text-green-600"}
              />
            </div>
            <div>
              <h2 className="font-display text-xl font-bold text-gray-900">
                {isSavedOffline
                  ? "Patient Saved Locally (Offline)"
                  : "Registration Successful!"}
              </h2>
              <p className="text-sm text-gray-500 mt-1">
                <strong>{registeredPatient?.name || form.name}</strong>{" "}
                {isSavedOffline
            ...
            <div className="bg-gradient-to-br from-teal-900 to-teal-800 text-white rounded-3xl p-6 shadow-xl text-left space-y-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-teal-200">
                      Share with patient for direct mobile login
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                <div className="p-3 bg-white/10 rounded-2xl">
                  ...
                  <div className="font-semibold text-sm text-white mt-0.5">
                    {registeredPatient?.name || form.name}
                  </div>
                  {registeredPatient?.nameHi && (
                ...
                <div className="p-3 bg-white/10 rounded-2xl">
                  <div className="text-[10px] uppercase font-bold text-teal-300">
                    {isSavedOffline ? "Temporary ID" : "Health ID"}
                  </div>
              ...
              <div className="p-3 bg-teal-700/40 rounded-2xl flex items-center justify-between text-xs text-teal-200">
                ...
                <strong className="text-white">
                  {registeredPatient?.healthWorkerName ||
            ...
            {isSavedOffline ? (
              <div className="flex flex-col items-center gap-1.5 text-xs text-amber-800 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <p className="text-amber-700 text-center">
                  It will automatically sync when internet connection is
                  restored.
                </p>
              ...
              {[
                {
                  label: "Copy ID",
                  icon: "document",
                  action: () => navigator.clipboard?.writeText(generatedId),
                },
